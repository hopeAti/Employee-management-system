...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light " style="background-color:#23472d;">
   ...
   <div class="card-body"style="background-color:#23472d;border:none;">
    <div class="input-group input-group-lg">
        <span class="input-group-addon" id="sizing-addon1"><img src="icon/32px-Crystal_Clear_app_kuser.png"></span>
         <input style="background-color:#23472d;border:none;" type="text" class="form-control" name="username" id="val1" placeholder="admin username" aria-describedby="sizing-addon1" required="" />
     </div>
     <br>
        <div class="input-group input-group-lg">
     ...
     <input type="submit" value="Sign In" id ="dd" class="btn btn-success btn-block btn-lg" name="log1" />
 </div>
        </form>
      </div>
   </div>
   <br>
   <div class="alert alert-info hide">All right Reserved &copy; <?php echo date('Y');?> Created By:</div>
   </center>
 </div>
   <br>
...
<style>
	 body{ 
     background:url(images/Orange-green\ match\,\ abstract\,\ 1080x2160\ wallpaper.jpeg); 
